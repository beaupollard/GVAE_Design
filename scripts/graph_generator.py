...
def set_length_location(min_x=-100,BLprev=0,bodyw=0,bodyh=0,zloc=0,yloc=0):
    err=False
    while err==False:
        body_length=get_gauss_rand(10.,4.,6.,14.)/39.37
        prop_radius=get_gauss_rand(8.,4.,4.,12.)/39.37
...
class graph_gens():
    def __init__(self):
        ...
        self.edge_index=[]
        self.body_nodes={"name":"body","length": 0,"width":20/39.37,"height":12/39.37,"clearance":0,"childern": [],"parents": [],"index":0}
        self.joint_nodes={"name":"joint","location": [0, 0, 0],"orientation":[0,0,0],"active":True,"childern": [],"parents": [],"index":1}
